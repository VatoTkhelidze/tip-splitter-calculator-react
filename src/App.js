...
import TipPercents from './components/TipPercents';
...
const CantBeZeroBottom = styled.span`
  display: ${({zeroBottom})=>zeroBottom ? 'block' : 'none'};
  position: absolute;
...
const CalculatorTextTip = styled.span`
  font-family: 'Space Mono';
  font-style: normal;
  font-weight: 700;
  font-size: 16px;
...
const SplitterTitle = styled.svg`
  align-self: center;
  margin-top: 50px;
`


const CalculatorSplitter = styled.div`
  display: flex;
  flex-direction: column;
  align-items: center;
`
